...
app.put('/users/:loggedInUser/sendFriendRequest/:requestedUser', UserController.sendFriendRequest)
app.put('/users/:loggedInUser/acceptFriendRequest/:requestingUser', UserController.acceptFriendRequest)
app.put('/users/:loggedInUser/declineFriendRequest/:requestingUser', UserController.declineFriendRequest)
app.put('/users/:loggedInUser/unfriend/:friendUserId', UserController.unfriend)
app.put('/users/:loggedInUser/cancelFriendRequest/:requestedFriendUserId', UserController.cancelFriendRequest)
